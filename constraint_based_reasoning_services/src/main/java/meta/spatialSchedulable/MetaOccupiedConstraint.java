...
public class MetaOccupiedConstraint extends MetaConstraint {
	...
	public ConstraintNetwork[] getMetaVariables() {
		...
		System.out.println("LENGTH " + this.metaCS.getVariables().length) ;
		for (int i = 0; i < this.metaCS.getVariables().length; i++) {
			System.out.println("CURRENT FLUENT: "  + ((SpatialFluent)this.metaCS.getVariables()[i]));
		}
