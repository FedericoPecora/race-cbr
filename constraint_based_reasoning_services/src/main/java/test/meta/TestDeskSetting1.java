...
//		operators.add(operator6);
	...
	private static void insertAtConstraint(Vector<SpatialAssertionalRelation2> saRelations, String str, long xl, long xu, long yl, long yu, boolean movable){
	...
	private static void getAssertionalRule(Vector<SpatialAssertionalRelation2> saRelations){
		...
		insertAtConstraint(saRelations, "table", 0, 120, 0, 120, false);
		insertAtConstraint(saRelations, "monitor", 25, 70, 80, 95, false);
		insertAtConstraint(saRelations, "pen", 25, 70, 80, 95, true);
		insertAtConstraint(saRelations, "book", 45, 55, 20, 30, true);
		insertAtConstraint(saRelations, "keyboard", 56, 106, 20, 40, true);
		insertAtConstraint(saRelations, "cup", 0, 0, 0, 0, true);
		insertAtConstraint(saRelations, "notebook", 0, 0, 0, 0, true);
		insertAtConstraint(saRelations, "phone", 26, 36, 6, 18, true);
		insertAtConstraint(saRelations, "penHolder", 30, 40, 30, 35, true);
		insertAtConstraint(saRelations, "ashtray", 100, 106, 10, 14, true);
