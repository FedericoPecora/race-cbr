...
//		AllenIntervalConstraint pickFinishesAt = new AllenIntervalConstraint(AllenIntervalConstraint.Type.Finishes, AllenIntervalConstraint.Type.OverlappedBy);
...
//		sa1.associateSpatialFlunt(tableFlunet);
		...
		sa3.setUnaryAtRectangleConstraint(new UnaryRectangleConstraint(UnaryRectangleConstraint.Type.At, 
				new Bounds(31, 31), new Bounds(37, 37), new Bounds(11, 11), new Bounds(30, 30)));
...
//				new Bounds(45,45), new Bounds(51,51), new Bounds(10, 10), new Bounds(33, 33)));
				new Bounds(40,40), new Bounds(46,46), new Bounds(10, 10), new Bounds(29, 29)));
