...
public class TestDomainWithManipulationArea {
...
//		Collections.sort(starttimes.values());
	...
	private static void insertCurrentStateCurrentGoal(SpatialFluentSolver grounSpatialFluentSolver) {
		...
		setFluentintoNetwork(cons, grounSpatialFluentSolver, "atLocation", "cup1_eatingArea1", "at_cup1_eatingArea1()", markings.UNJUSTIFIED, 22);
