...
//		operators.add(operator411a);
	...
	private static HashMap<String, Rectangle> getAssertionalRule(Vector<SpatialAssertionalRelation2> saRelations){
		...
		insertAtConstraint(recs, saRelations, "book", 98, 108, 57, 67, true);
...
//		insertAtConstraint(recs,saRelations, "pen", 0, 0, 0, 0, true);
//		insertAtConstraint(recs,saRelations, "book", 0, 0, 0, 0, true);
//		insertAtConstraint(recs,saRelations, "keyboard", 0, 0, 0, 0, true);
//		insertAtConstraint(recs,saRelations, "cup", 0, 0, 0, 0, true);
//		insertAtConstraint(recs,saRelations, "notebook", 0, 0, 0, 0, true);
//		insertAtConstraint(recs,saRelations, "phone", 0, 0, 0, 0, true);
//		insertAtConstraint(recs,saRelations, "penHolder", 0, 0, 0, 0, true);
//		insertAtConstraint(recs,saRelations, "ashtray", 0, 0, 0, 0, true);
